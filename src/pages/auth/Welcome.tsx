        ...
        <div className="w-full max-w-md mx-auto">
          ...
          >
            <div className="text-center">
              <h1 className="text-3xl font-bold text-white mb-3">Welcome to FuelFriendly</h1>
              <p className="text-gray-400 text-lg">Your smart fueling companion</p>
            </div>
            ...
            <div className="space-y-4 max-w-md mx-auto">
              ...
              <Button 
                ...
                variant="outline" 
                className="w-full h-14 rounded-full border-2 border-green-500 bg-transparent text-white hover:bg-green-500/10 font-medium text-lg"
              >
