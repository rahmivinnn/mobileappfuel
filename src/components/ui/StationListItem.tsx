...
import { MapPin, Star, Banknote } from 'lucide-react';
...
const StationListItem: React.FC<StationListItemProps> = ({
  ...
  return (
    <motion.div
      className="w-full bg-white dark:bg-gray-900 rounded-xl overflow-hidden mb-4"
      ...
      <div className="flex p-2 gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center text-orange-500 mt-1 gap-2">
            ...
            <p className="text-right flex-1">{distance} miles</p>
          </div>
